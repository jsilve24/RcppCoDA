...
namespace coda{
  ...
  Eigen::MatrixXd glr(Eigen::MatrixBase<TX>& X, Eigen::MatrixBase<TV1>& V1){ // was MatrixBase and SparseMatrixBase
    int P1 = V1.rows();
    int D1 = V1.cols();
    int D = X.rows();
    int D2 = D-D1;
  ...
  //' @rdname glr
  template <typename TX, typename TV1>
  Eigen::MatrixXd glr(Eigen::MatrixBase<TX>& X, Eigen::SparseMatrixBase<TV1>& V1){ // was MatrixBase and SparseMatrixBase
    int P1 = V1.rows();
    int D1 = V1.cols();
    int D = X.rows();
    int D2 = D-D1;
  ...
  Eigen::MatrixXd glr(Eigen::MatrixBase<TX>& X, 
                      ...
                      Eigen::MatrixBase<TV2>& V2){ // was MatrixBase and SparseMatrixBase
    int P1 = V1.rows();
    int D1 = V1.cols();
    int P2 = V2.rows();
    int D2 = V2.cols();
  ...
  Eigen::MatrixXd glr(Eigen::MatrixBase<TX>& X, 
                      Eigen::MatrixBase<TV1>& V1, 
                      Eigen::SparseMatrixBase<TV2>& V2){ // was MatrixBase and SparseMatrixBase
    int P1 = V1.rows();
    int D1 = V1.cols();
    int P2 = V2.rows();
    int D2 = V2.cols();
  ...
  //' @rdname glr
  template <typename TX, typename TV1>
  Eigen::MatrixXd glrInv(Eigen::MatrixBase<TX>& X, Eigen::MatrixBase<TV1>& V1){
    int P1 = V1.rows();
    int D1 = V1.cols();
    int P = X.rows();
    int P2 = P-P1;
  ...
  //' @rdname glr
  template <typename TX, typename TV1>
  Eigen::MatrixXd glrInv(Eigen::MatrixBase<TX>& X, Eigen::SparseMatrixBase<TV1>& V1){
    int P1 = V1.rows();
    int D1 = V1.cols();
    int P = X.rows();
    int P2 = P-P1;
  ...
  //' @rdname glr
  template <typename TX, typename TV1, typename TV2>
  Eigen::MatrixXd glrInv(Eigen::MatrixBase<TX>& X, 
                         Eigen::MatrixBase<TV1>& V1, 
